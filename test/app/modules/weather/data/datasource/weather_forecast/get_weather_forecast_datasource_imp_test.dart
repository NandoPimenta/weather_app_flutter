...
void main() {
  test('GetWeatherForecastDatasourceImp should return data on success', () async {
    // Arrange
    final apiService = ApiService();
    final weatherService = WeatherService();
    final datasource = GetWeatherForecastDatasourceImp(apiService: apiService, weatherService: weatherService);
  ...
  test('GetWeatherForecastDatasourceImp should throw an exception on failure', () async {
    // Arrange
